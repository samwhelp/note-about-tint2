...
is_debug () {
	if [ "$DEBUG_TINT2_THEME_LAUNCHER" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='tint2-theme-launcher'
	fi
	...
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-tint2/gh-pages/_demo/config/tint2-config/modeling-theme-basic/tool/tint2-theme-launcher/tint2-theme-launcher'
	...
	THE_TINT2_THEME_ROOT_DIR_NAME="theme"
